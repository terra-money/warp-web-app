import { CW20TokensResponse, IBCTokensResponse, TokensResponse } from '../../types';

export const fixTokenResponse = <T extends IBCTokensResponse | CW20TokensResponse | TokensResponse>(
  type: 'cw20' | 'ibc',
  tokens: T,
  ...
  return Object.keys(tokens).reduce((prev, current) => {
    ...
    return {
      ...
      [key]: {
        ...
        decimals:
          tokens[current].decimals === undefined || tokens[current].decimals === 0 ? 6 : tokens[current].decimals,
      },
    };
  }, {});
};
