...
import { useFundingAccountsQueryv2 } from 'queries/useFundingAccountsQueryv2';
import { ActionButton } from 'components/action-button/ActionButton';
import { useMigrateFundsDialog } from 'components/layout/migrate-jobs/migrate-funds/MigrateFundsDialog';
...
const FundingAccountListDialog = (props: DialogProps<void, string>) => {
  ...
  const { data: fundingAccounts = [], isLoading } = useFundingAccountsQueryv2({
